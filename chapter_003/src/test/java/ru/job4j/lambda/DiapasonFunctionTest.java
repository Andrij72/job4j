...
public class DiapasonFunctionTest {
    ...
    public void whenLinearFunctionThenLinearResults() {
        ...
        List<Double> expected = Arrays.asList(21D, 25D, 29D);
    ...
    public void whenQuadraticFunction() {
        ...
        List<Double> expected = Arrays.asList(5D, 17D, 37D);
        assertThat(result, is(expected));
    }
    ...
    public void whenLogarithmicFunction() {
        ...
        List<Double> expected = Arrays.asList(1.6094379124341003D, 1.9459101490553132D);
        assertThat(result, is(expected));
    }
}
